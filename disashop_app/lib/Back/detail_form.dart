...
class DetailsForms {
  ...
  factory DetailsForms.fromRawJson(String str) =>
      DetailsForms.fromJson(json.decode(str));
...
class FieldDependentOn {
  ...
  factory FieldDependentOn.fromRawJson(String str) =>
      FieldDependentOn.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory FieldDependentOn.fromJson(Map<String, dynamic> json) =>
      FieldDependentOn(
        fieldId: json["field_id"],
...
class FieldValidations {
  ...
  factory FieldValidations.fromRawJson(String str) =>
      FieldValidations.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory FieldValidations.fromJson(Map<String, dynamic> json) =>
      FieldValidations(
...
class FormGroup {
  ...
  factory FormGroup.fromRawJson(String str) =>
      FormGroup.fromJson(json.decode(str));
...
class TitleField {
  ...
  factory TitleField.fromRawJson(String str) =>
      TitleField.fromJson(json.decode(str));
